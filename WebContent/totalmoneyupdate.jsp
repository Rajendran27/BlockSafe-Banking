...
<%String chemail=session.getAttribute("useremail").toString(); %>
...
String bname="";
  ...
  String amount="";
	 ...
	 PreparedStatement p1 = d.prepareStatement("SELECT * FROM `bankingemail`.`userreg` where email='"+chemail+"'");
	 ...
	 PreparedStatement p = d.prepareStatement("SELECT sum(balance) FROM `bankingemail`.`userreg` where email='"+chemail+"'");
    ...
    <div class="profile">
      ...
      <div class="details">
        <%=chemail %> <br> <span>ID: 2014112</span>
      </div>
    </div>
