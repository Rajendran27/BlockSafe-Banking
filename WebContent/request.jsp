...
con=dbconn.create();
PreparedStatement ps=con.prepareStatement("SELECT * FROM `bankingemail`.`userreg` where status='apply' and type='old'");
...
%>
      ...
      <tbody>
        ...
        <td><%=  rs.getString(8) %></td>
          ...
          <td>
		     <a href="accept.jsp?id=<%=rs.getString(1)%>&&email=<%=rs.getString(3)%>&&type=1">
